...
import { Target, Eye, Heart, Handshake, Lightbulb, Award, TrendingUp, Users, Shield } from 'lucide-react';
import Topbar from '../components/Topbar';
import Navbar from '../components/Navbar';
import Footer from '../components/Footer';
import WhatsAppWidget from '../components/WhatsAppWidget';
import PresenceMap from '../components/PresenceMap';
import puertoImg from '/images/puerto.jpg';
            ...
            <main className="pt-[96px] sm:pt-[120px] md:pt-[136px]">
                ...
                <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#1D1D1B] via-[#2D2D2B] to-[#1D1D1B]">
                    ...
                    <div className="absolute inset-0 opacity-20">
                        ...
                        <div className="absolute bottom-20 right-20 w-96 h-96 bg-purple-500 rounded-full filter blur-[120px] animate-pulse delay-700"></div>
                    ...
                    <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
                        ...
                        >
                            Conoce a <span className="bg-gradient-to-r from-purple-400 to-purple-400 bg-clip-text text-transparent">VÍREMO</span>
                        </motion.h1>
                ...
                <section className="py-20 bg-white">
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        >
                            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-600 to-purple-600 bg-clip-text text-transparent">
                                ¿Quiénes Somos?
                            </h2>
                        </motion.div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                transition={{ duration: 0.8, delay: 0.2 }}
                                className="bg-gradient-to-br from-purple-50 to-purple-50 p-8 rounded-3xl border border-purple-200 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2"
                            >
                                    <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
                            ...
                            >
                                ...
                                <p className="text-gray-700 leading-relaxed">
                                    Nuestra experiencia, sumada al compromiso de la <span className="font-bold">mejora continua</span>, nos posiciona como un aliado confiable para operaciones críticas y de alta responsabilidad operativa.
                                </p>
                            </motion.div>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="grid md:grid-cols-2 gap-12">
                            ...
                            <motion.div
                                ...
                                className="relative"
                            >
                                <div className="absolute -inset-4 bg-gradient-to-r from-purple-500 to-purple-500 rounded-3xl opacity-20 blur-xl"></div>
                                <div className="relative bg-white p-10 rounded-3xl shadow-xl border border-purple-100">
                                    <div className="flex items-center gap-4 mb-6">
                                            <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-500 rounded-2xl flex items-center justify-center shadow-lg">
                                            <Target className="text-white" size={32} />
                                        </div>
                                        <h3 className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-purple-600 bg-clip-text text-transparent">
                                            Nuestra Misión
                                        </h3>
                                    </div>
                            ...
                            >
                                ...
                                <div className="relative bg-white p-10 rounded-3xl shadow-xl border border-purple-100">
                                    ...
                                    <p className="text-gray-700 text-lg leading-relaxed">
                                        "Consolidarnos en el mercado nacional como una empresa <span className="font-bold">líder en Servicios de Logística Integral</span> y Transporte Especializado, respaldada por una estructura organizacional sólida, y un firme compromiso con el crecimiento, la confianza y el bienestar de quienes forman parte de nuestra cadena de valor".
                                    </p>
                                </div>
                            </motion.div>
                ...
                <section className="py-20 bg-gradient-to-br from-[#1D1D1B] to-[#2D2D2B] relative overflow-hidden">
                    <div className="absolute inset-0 opacity-10">
                        ...
                        <div className="absolute bottom-10 left-20 w-96 h-96 bg-purple-500 rounded-full filter blur-[100px] animate-pulse delay-500"></div>
                    </div>
                    ...
                    <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
                        ...
                        >
                            <div className="flex justify-center mb-8">
                                <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-purple-500 rounded-3xl flex items-center justify-center shadow-2xl shadow-purple-500/50">
                                    <Handshake className="text-white" size={40} />
                                </div>
                            </div>

                            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-white">
                                Nuestra <span className="bg-gradient-to-r from-purple-400 to-purple-400 bg-clip-text text-transparent">Filosofía</span>
                            </h2>

                            <p className="text-xl md:text-2xl text-gray-300 leading-relaxed">
                                "En Víremo <span className="font-bold">no movemos carga</span>, creamos soluciones seguras para desafíos reales. Nuestro compromiso es ser el lazo que une tus necesidades con soluciones logísticas y de transporte especializadas, garantizando la <span className="font-bold">tranquilidad en cada envío</span>."
                            </p>
                        </motion.div>
                    </div>
                </section>
                            ...
                            {valores.map((valor, index) => (
                                ...
                                >
                                    ...
                                    <div className="relative bg-white p-8 rounded-3xl border border-gray-200 shadow-lg hover:shadow-2xl transition-all duration-300 h-full">
                                        ...
                                        <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-purple-600 to-purple-600 bg-clip-text text-transparent">
                                            {valor.title}
                                        </h3>
                                        <p className="text-gray-700 leading-relaxed">
                                            {valor.description}
                ...
                >
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
                        ...
                        >
                            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-6 text-white">
                                NUESTRA <span className="font-bold text-white">PRESENCIA</span>
                            </h2>
                            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 max-w-3xl mx-auto text-justify px-2">
                        ...
                        >
                            ...
                            <div className="relative left-1/2 right-1/2 w-screen -translate-x-1/2 ">
                                <PresenceMap puertos={puertos} height={400} scale={isMobile ? 1400 : 800} />
                            </div>
                        </motion.div>
                    </div>
                </section>
